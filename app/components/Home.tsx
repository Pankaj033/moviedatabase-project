      ...
      <div className="container mx-auto min-h-[calc(100vh-77px)] flex items-center relative">
        <div className="flex-col lg:flex-row flex gap-10 lg:mx-10 py-20">
          ...
          <div className="space-y-6">
            <div className="uppercase -translate-y-3 text-[26px] md:text-[34px] font-medium pr-1 text-white">
              {movie?.title}
            </div>
            ...
            <div className="pt-7 space-y-1 pr-2">
              <div>StoryLine:</div>
            ...
            >
              <div className="flex gap-1 items-center bg-white text-black px-2 py-2 mb-1 pr-1 hover:bg-[#b4b4b4]">
                <BsPlayFill size={24} />
                Watch Trailer
              </div>
            </div>
